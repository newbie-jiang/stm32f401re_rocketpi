...
## 02_don't_approach_me_alarm 应用说明
...
2) 上电后通过串口监视日志，使用 HX1838/NEC 遥控按上述键位调整参数。  
...
<!-- BSP_DRIVERS_START -->
<!-- BSP_DRIVERS_HASH:f5ddb30cc268e8cd1c34c10ee5f8f3158553fa99eaff81d169d12a241d0b241d -->
## 驱动以及测试代码
