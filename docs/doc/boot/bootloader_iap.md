...
- 开机后检测按用户按键是否按下，按键按下则进入IAP升级模式（可通过串口查看）
- 5S后未按下则跳转到app执行
...
<!-- BSP_DRIVERS_START -->
<!-- BSP_DRIVERS_HASH:8e4edbdef068c74f63fc38369a08dccda3b5b30f9fefb11fda8b1357ee9b9c79 -->
## 驱动以及测试代码

<details>
<summary>app1/Core/Src/main.c</summary>
...
<details>
<summary>app2/Core/Src/main.c</summary>
