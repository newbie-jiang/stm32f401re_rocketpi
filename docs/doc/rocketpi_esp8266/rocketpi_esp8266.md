...
[ESP8266][event][ok] OK (cmd=AT)
[ESP8266][CIPSTA?] OK
        STA ip=192.168.1.71 gateway=192.168.1.1 netmask=255.255.255.0
...
[ESP8266][MQTTCONN] OK
[ESP8266][event][error] ERROR (cmd=AT)
...
<!-- BSP_DRIVERS_START -->
<!-- BSP_DRIVERS_HASH:3c5371589c393547d3c80ca5f3f1536eba3b9fa68133665f711bc1a184a470dc -->
## 驱动以及测试代码
